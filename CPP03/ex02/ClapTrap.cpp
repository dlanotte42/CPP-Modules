...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/10 20:19:08 by zxcvbinz          #+#    #+#             */
/*   Updated: 2022/10/10 20:19:09 by zxcvbinz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(): _name("** default name **"), _hitpoints(10), _energyPoints(10), _attackDamage(0){
	std::cout << "CLAPTRAP CONSTRUCTOR: " << this->_name << " constructor has been called" << std::endl; 
	return;
}
